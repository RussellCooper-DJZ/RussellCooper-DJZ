...
|---|---|---|---|
| [RCclaw](https://github.com/RussellCooper-DJZ/RCclaw) | Agent infrastructure | Multi-channel AI gateway with extensible messaging integrations. | TypeScript · AI agents |
| [TrendRadar](https://github.com/RussellCooper-DJZ/TrendRadar) | AI intelligence | Multi-platform trend monitoring, automated notifications and conversational analysis. | Python · MCP · Automation |
| [BettaFish](https://github.com/RussellCooper-DJZ/BettaFish) | Multi-agent analysis | A framework-independent multi-agent assistant for public-opinion analysis. | Python · Multi-agent systems |
| [manbo-robot-dog](https://github.com/RussellCooper-DJZ/manbo-robot-dog) | Embedded robotics | STM32-based desktop quadruped robot with voice interaction, obstacle avoidance and expressive displays. | C · STM32 · Hardware |
